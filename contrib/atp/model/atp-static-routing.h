...
#ifndef ATP_STATIC_ROUTING_H
#define ATP_STATIC_ROUTING_H
 ...
 */
class ATPStaticRouting : public Ipv4RoutingProtocol
{
  public:
    /**
    ...
    Ptr<ATPL4Protocol> GetATPL4Protocol() { return m_ipv4->GetObject<ATPL4Protocol>(); };
