 ...
 */
#ifndef ATP_BRIDGE_NET_DEVICE_H
...
class ATPBridgeNetDevice : public NetDevice
{
  public:
    ...
    ATPBridgeNetDevice();
    ~ATPBridgeNetDevice() override;

    // Delete copy constructor and assignment operator to avoid misuse
    ATPBridgeNetDevice(const ATPBridgeNetDevice&) = delete;
    ATPBridgeNetDevice& operator=(const ATPBridgeNetDevice&) = delete;
  ...
  private:
    ...
    Ptr<ATPBridgeChannel> m_channel;                   //!< virtual bridged channel
