...
NS_LOG_COMPONENT_DEFINE("ATPCsmaNetDevice");

NS_OBJECT_ENSURE_REGISTERED(ATPCsmaNetDevice);

TypeId
ATPCsmaNetDevice::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::ATPCsmaNetDevice")
            .SetParent<NetDevice>()
            .SetGroupName("Csma")
            .AddConstructor<ATPCsmaNetDevice>()
            .AddAttribute("Address",
                          "The MAC address of this device.",
                          Mac48AddressValue(Mac48Address("ff:ff:ff:ff:ff:ff")),
                          MakeMac48AddressAccessor(&ATPCsmaNetDevice::m_address),
                          MakeMac48AddressChecker())
            .AddAttribute("Mtu",
                          "The MAC-level Maximum Transmission Unit",
                          UintegerValue(DEFAULT_MTU),
                          MakeUintegerAccessor(&ATPCsmaNetDevice::SetMtu, &ATPCsmaNetDevice::GetMtu),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("EncapsulationMode",
                          "The link-layer encapsulation type to use.",
                          EnumValue(DIX),
                          MakeEnumAccessor<EncapsulationMode>(&ATPCsmaNetDevice::SetEncapsulationMode),
                          MakeEnumChecker(DIX, "Dix", LLC, "Llc"))
            .AddAttribute("SendEnable",
                          "Enable or disable the transmitter section of the device.",
                          BooleanValue(true),
                          MakeBooleanAccessor(&ATPCsmaNetDevice::m_sendEnable),
                          MakeBooleanChecker())
            .AddAttribute("ReceiveEnable",
                          "Enable or disable the receiver section of the device.",
                          BooleanValue(true),
                          MakeBooleanAccessor(&ATPCsmaNetDevice::m_receiveEnable),
                          MakeBooleanChecker())
            .AddAttribute("ReceiveErrorModel",
                          "The receiver error model used to simulate packet loss",
                          PointerValue(),
                          MakePointerAccessor(&ATPCsmaNetDevice::m_receiveErrorModel),
            ...
            .AddAttribute("TxQueue",
                          ...
                          PointerValue(),
                          MakePointerAccessor(&ATPCsmaNetDevice::m_queue),
            ...
            .AddTraceSource("MacTx",
                            ...
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_macTxTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacTxDrop",
                            "Trace source indicating a packet has been "
                            "dropped by the device before transmission",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_macTxDropTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacPromiscRx",
                            ...
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_macPromiscRxTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacRx",
                            ...
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_macRxTrace),
                            "ns3::Packet::TracedCallback")
#if 0
    ...
    .AddTraceSource ("MacRxDrop",
                     ...
                     MakeTraceSourceAccessor (&ATPCsmaNetDevice::m_macRxDropTrace),
                     "ns3::Packet::TracedCallback")
#endif
            .AddTraceSource("MacTxBackoff",
                            "Trace source indicating a packet has been "
                            "delayed by the CSMA backoff process",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_macTxBackoffTrace),
                            "ns3::Packet::TracedCallback")
            //
            ...
            .AddTraceSource("PhyTxBegin",
                            ...
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_phyTxBeginTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PhyTxEnd",
                            "Trace source indicating a packet has been "
                            "completely transmitted over the channel",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_phyTxEndTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PhyTxDrop",
                            "Trace source indicating a packet has been "
                            "dropped by the device during transmission",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_phyTxDropTrace),
                            "ns3::Packet::TracedCallback")
#if 0
    // Not currently implemented in this device
    .AddTraceSource ("PhyRxBegin",
                     ...
                     MakeTraceSourceAccessor (&ATPCsmaNetDevice::m_phyRxBeginTrace),
                     "ns3::Packet::TracedCallback")
#endif
            .AddTraceSource("PhyRxEnd",
                            "Trace source indicating a packet has been "
                            "completely received by the device",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_phyRxEndTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PhyRxDrop",
                            "Trace source indicating a packet has been "
                            "dropped by the device during reception",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_phyRxDropTrace),
                            "ns3::Packet::TracedCallback")
            //
            ...
            .AddTraceSource("Sniffer",
                            ...
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_snifferTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PromiscSniffer",
                            "Trace source simulating a promiscuous "
                            "packet sniffer attached to the device",
                            MakeTraceSourceAccessor(&ATPCsmaNetDevice::m_promiscSnifferTrace),
                            "ns3::Packet::TracedCallback");
    return tid;
}

ATPCsmaNetDevice::ATPCsmaNetDevice()
    : m_linkUp(false)
{
...
void
ATPCsmaNetDevice::SetEncapsulationMode(EncapsulationMode mode)
{
...
ATPCsmaNetDevice::EncapsulationMode
ATPCsmaNetDevice::GetEncapsulationMode()
{
    NS_LOG_FUNCTION_NOARGS();
    return m_encapMode;
}
...
bool
ATPCsmaNetDevice::SetMtu(uint16_t mtu)
{
...
void
ATPCsmaNetDevice::SetSendEnable(bool sendEnable)
{
...
void
ATPCsmaNetDevice::SetReceiveEnable(bool receiveEnable)
{
...
bool
ATPCsmaNetDevice::IsSendEnabled() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_sendEnable;
}
...
bool
ATPCsmaNetDevice::IsReceiveEnabled() const
{
    NS_LOG_FUNCTION_NOARGS();
...
void
ATPCsmaNetDevice::SetInterframeGap(Time t)
{
    NS_LOG_FUNCTION(t);
    m_tInterframeGap = t;
}
...
void
ATPCsmaNetDevice::SetBackoffParams(Time slotTime,
                                uint32_t minSlots,
                                uint32_t maxSlots,
                                uint32_t ceiling,
                                uint32_t maxRetries)
...
void
ATPCsmaNetDevice::AddHeader(Ptr<Packet> p,
                         Mac48Address source,
                         Mac48Address dest,
                         uint16_t protocolNumber)
{
    ...
    case LLC: {
        ...
        NS_ASSERT_MSG(p->GetSize() <= GetMtu(),
                      "ATPCsmaNetDevice::AddHeader(): 802.3 Length/Type field with LLC/SNAP: "
                      "length interpretation must not exceed device frame size minus overhead");
    }
    break;
    case ILLEGAL:
    default:
        NS_FATAL_ERROR("ATPCsmaNetDevice::AddHeader(): Unknown packet encapsulation mode");
        break;
    }
...
#if 0
bool
ATPCsmaNetDevice::ProcessHeader (Ptr<Packet> p, uint16_t & param)
{
  ...
  switch (m_encapMode)
    ...
    case ILLEGAL:
    default:
      NS_FATAL_ERROR ("ATPCsmaNetDevice::ProcessHeader(): Unknown packet encapsulation mode");
      break;
    }
  return true;
}
...
void
ATPCsmaNetDevice::TransmitStart()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    //
    NS_ASSERT_MSG(m_currentPkt, "ATPCsmaNetDevice::TransmitStart(): m_currentPkt not set");
    ...
    //
    if (m_channel->GetState() != ATP_IDLE)
    {
        //
        ...
        else
        {
            ...
            Simulator::Schedule(backoffTime, &ATPCsmaNetDevice::TransmitStart, this);
        }
    }
    else
    {
        ...
        else
        {
            ...
            Simulator::Schedule(tEvent, &ATPCsmaNetDevice::TransmitCompleteEvent, this);
        }
    }
}

void
ATPCsmaNetDevice::TransmitAbort()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    //
    NS_ASSERT_MSG(m_currentPkt, "ATPCsmaNetDevice::TransmitAbort(): m_currentPkt zero");
    NS_LOG_LOGIC("m_currentPkt=" << m_currentPkt);
    ...
    else
    {
        ...
        NS_ASSERT_MSG(packet,
                      "ATPCsmaNetDevice::TransmitAbort(): IsEmpty false but no Packet on queue?");
        m_currentPkt = packet;
...
void
ATPCsmaNetDevice::TransmitCompleteEvent()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    NS_ASSERT_MSG(m_txMachineState == BUSY,
                  "ATPCsmaNetDevice::transmitCompleteEvent(): Must be BUSY if transmitting");
    NS_ASSERT(m_channel->GetState() == ATP_TRANSMITTING);
    ...
    //
    NS_ASSERT_MSG(m_currentPkt, "ATPCsmaNetDevice::TransmitCompleteEvent(): m_currentPkt zero");
    NS_LOG_LOGIC("m_currentPkt=" << m_currentPkt);
    NS_LOG_LOGIC("Pkt UID is " << m_currentPkt->GetUid() << ")");
    ...
    Simulator::Schedule(m_tInterframeGap, &ATPCsmaNetDevice::TransmitReadyEvent, this);
}

void
ATPCsmaNetDevice::TransmitReadyEvent()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    NS_ASSERT_MSG(m_txMachineState == GAP,
                  "ATPCsmaNetDevice::TransmitReadyEvent(): Must be in interframe gap");
    m_txMachineState = READY;
    ...
    //
    NS_ASSERT_MSG(!m_currentPkt, "ATPCsmaNetDevice::TransmitReadyEvent(): m_currentPkt nonzero");
    ...
    else
    {
        Ptr<Packet> packet = m_queue->Dequeue();
        NS_ASSERT_MSG(packet,
                      "ATPCsmaNetDevice::TransmitReadyEvent(): IsEmpty false but no Packet on queue?");
        m_currentPkt = packet;
        m_snifferTrace(m_currentPkt);
        m_promiscSnifferTrace(m_currentPkt);
        TransmitStart();
...
bool
ATPCsmaNetDevice::Attach(Ptr<ATPCsmaChannel> ch)
{
...
void
ATPCsmaNetDevice::SetQueue(Ptr<Queue<Packet>> q)
{
    NS_LOG_FUNCTION(q);
    m_queue = q;
}
...
void
ATPCsmaNetDevice::SetReceiveErrorModel(Ptr<ErrorModel> em)
{
    NS_LOG_FUNCTION(em);
...
void
ATPCsmaNetDevice::Receive(Ptr<const Packet> packet, Ptr<ATPCsmaNetDevice> senderDevice)
{
...
Ptr<Queue<Packet>>
ATPCsmaNetDevice::GetQueue() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_queue;
}
...
void
ATPCsmaNetDevice::SetIfIndex(const uint32_t index)
{
...
uint32_t
ATPCsmaNetDevice::GetIfIndex() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_ifIndex;
}
...
Ptr<Channel>
ATPCsmaNetDevice::GetChannel() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_channel;
}
...
void
ATPCsmaNetDevice::SetAddress(Address address)
{
    NS_LOG_FUNCTION_NOARGS();
...
Address
ATPCsmaNetDevice::GetAddress() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_address;
}
...
bool
ATPCsmaNetDevice::IsLinkUp() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_linkUp;
}
...
void
ATPCsmaNetDevice::AddLinkChangeCallback(Callback<void> callback)
{
...
bool
ATPCsmaNetDevice::IsBroadcast() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
Address
ATPCsmaNetDevice::GetBroadcast() const
{
    NS_LOG_FUNCTION_NOARGS();
...
bool
ATPCsmaNetDevice::IsMulticast() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
Address
ATPCsmaNetDevice::GetMulticast(Ipv4Address multicastGroup) const
{
...
bool
ATPCsmaNetDevice::IsPointToPoint() const
{
    NS_LOG_FUNCTION_NOARGS();
    return false;
}
...
bool
ATPCsmaNetDevice::IsBridge() const
{
    NS_LOG_FUNCTION_NOARGS();
    return false;
}
...
bool
ATPCsmaNetDevice::SendFrom(Ptr<Packet> packet,
                        const Address& src,
                        const Address& dest,
                        uint16_t protocolNumber)
{
    ...
    if (m_txMachineState == READY)
    {
        if (!m_queue->IsEmpty())
        {
            Ptr<Packet> packet = m_queue->Dequeue();
            NS_ASSERT_MSG(packet,
                          "ATPCsmaNetDevice::SendFrom(): IsEmpty false but no Packet on queue?");
            m_currentPkt = packet;
            m_promiscSnifferTrace(m_currentPkt);
            m_snifferTrace(m_currentPkt);
            TransmitStart();
...
Ptr<Node>
ATPCsmaNetDevice::GetNode() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_node;
}
...
void
ATPCsmaNetDevice::SetNode(Ptr<Node> node)
{
...
bool
ATPCsmaNetDevice::NeedsArp() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
void
ATPCsmaNetDevice::SetReceiveCallback(NetDevice::ReceiveCallback cb)
{
    NS_LOG_FUNCTION(&cb);
    m_rxCallback = cb;
}
...
Address
ATPCsmaNetDevice::GetMulticast(Ipv6Address addr) const
{
...
void
ATPCsmaNetDevice::SetPromiscReceiveCallback(NetDevice::PromiscReceiveCallback cb)
{
    NS_LOG_FUNCTION(&cb);
...
bool
ATPCsmaNetDevice::SupportsSendFrom() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
