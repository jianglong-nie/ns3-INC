...
#ifndef ATP_CSMA_NET_DEVICE_H
#define ATP_CSMA_NET_DEVICE_H
...
class ATPCsmaNetDevice : public NetDevice
{
  public:
    ...
    /**
     * Construct a ATPCsmaNetDevice
     *
     * This is the default constructor for a ATPCsmaNetDevice.
     */
    ATPCsmaNetDevice();

    /**
     * Destroy a ATPCsmaNetDevice
     *
     * This is the destructor for a ATPCsmaNetDevice.
     */
    ~ATPCsmaNetDevice() override;
     ...
     *
     * The function Attach is used to add a ATPCsmaNetDevice to a ATPCsmaChannel.
     *
     * \see SetDataRate ()
     ...
     */
    bool Attach(Ptr<ATPCsmaChannel> ch);

    /**
     * Attach a queue to the ATPCsmaNetDevice.
     *
     * The ATPCsmaNetDevice "owns" a queue.  This queue may be set by higher
    ...
    /**
     * Attach a receive ErrorModel to the ATPCsmaNetDevice.
     *
     * The ATPCsmaNetDevice may optionally include an ErrorModel in
    ...
    /**
     * Receive a packet from a connected ATPCsmaChannel.
     *
     * The ATPCsmaNetDevice receives packets from its connected channel
     ...
     * \param sender the ATPCsmaNetDevice that transmitted the packet in the first place
     */
    void Receive(Ptr<const Packet> p, Ptr<ATPCsmaNetDevice> sender);
     ...
     *
     */
    void SetEncapsulationMode(ATPCsmaNetDevice::EncapsulationMode mode);
  ...
  private:
     ...
     * operator for ATPCsmaNetDevice objects.
     * \param o object to copy
     * \returns the copied object
     */
    ATPCsmaNetDevice& operator=(const ATPCsmaNetDevice& o);

    /**
     * Copy constructor is declared but not implemented.  This disables the
     * copy constructor for ATPCsmaNetDevice objects.
     * \param o object to copy
     */
    ATPCsmaNetDevice(const ATPCsmaNetDevice& o);
     ...
     * the ATPCsmaNetDevice to begin the process of sending a packet
     ...
     *
     * \see ATPCsmaChannel::TransmitStart ()
     ...
     *
     * \see ATPCsmaChannel::TransmitEnd ()
    ...
    /**
     * The ATPCsmaChannel to which this ATPCsmaNetDevice has been
     * attached.
     * \see class ATPCsmaChannel
     */
    Ptr<ATPCsmaChannel> m_channel;

    /**
     * The Queue which this ATPCsmaNetDevice uses as a packet source.
     * Management of this Queue has been delegated to the ATPCsmaNetDevice
    ...
    /**
     * Default Maximum Transmission Unit (MTU) for the ATPCsmaNetDevice
     */
