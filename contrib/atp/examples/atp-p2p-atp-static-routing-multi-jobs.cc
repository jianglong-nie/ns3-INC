...
main(int argc, char* argv[])
{
    ...
    cwndStream_n0_job1.open("atp-result/trace-p2p-multi-job/n0-job1-cwnd-p2p-multi-job.txt", std::ofstream::out | std::ofstream::trunc);
    cwndStream_n1_job1.open("atp-result/trace-p2p-multi-job/n1-job1-cwnd-p2p-multi-job.txt", std::ofstream::out | std::ofstream::trunc);
    SinkBytesStream_job1.open("atp-result/trace-p2p-multi-job/n0-job1-sinkBytes-p2p-multi-job.txt", std::ofstream::out | std::ofstream::trunc);
    ...
    Ptr<ATPStaticRouting> staticRouting_n0 = staticRoutingHelper.GetStaticRouting(ipv4_n0);
    Ptr<ATPStaticRouting> staticRouting_n1 = staticRoutingHelper.GetStaticRouting(ipv4_n1);
