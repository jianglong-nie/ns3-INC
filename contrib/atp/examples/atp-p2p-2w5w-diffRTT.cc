...
main(int argc, char* argv[])
{
    ...
    uint32_t maxBytes = 0;
    Time stopTime = Seconds(1.0) + MicroSeconds(5000); // 9.6us为一个rtt时间，近似为10us，这里跑2000个rtt
    ...
    // Install m0-m1 to n5 links with 10us delay
    pointToPoint.SetChannelAttribute("Delay", ns3::StringValue("10us"));
