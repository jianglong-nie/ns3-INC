...
main(int argc, char* argv[])
{
    ...
    cwndStream_n0_job1.open("atp-result/trace-p2p-2w2w-diffRTT/n0-job1-cwnd-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
    cwndStream_n1_job1.open("atp-result/trace-p2p-2w2w-diffRTT/n1-job1-cwnd-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
    cwndStream_m0_job2.open("atp-result/trace-p2p-2w2w-diffRTT/m0-job2-cwnd-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
    cwndStream_m1_job2.open("atp-result/trace-p2p-2w2w-diffRTT/m1-job2-cwnd-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
    SinkBytesStream_job1.open("atp-result/trace-p2p-2w2w-diffRTT/job1-sinkBytes-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
    SinkBytesStream_job2.open("atp-result/trace-p2p-2w2w-diffRTT/job2-sinkBytes-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
    queueSizeStream_n2.open("atp-result/trace-p2p-2w2w-diffRTT/n2-queueSize-p2p-2w2w-diffRTT.txt", std::ofstream::out | std::ofstream::trunc);
