...
#ifndef ATP_PACKET_SINK_HELPER_H
#define ATP_PACKET_SINK_HELPER_H
 ...
 * on a set of nodes.
 */
class ATPPacketSinkHelper : public ApplicationHelper
{
  public:
    /**
     ...
     *
     */
    ATPPacketSinkHelper(const std::string& protocol, const Address& address);
};

} // namespace ns3

#endif /* ATP_PACKET_SINK_HELPER_H */
