...
#ifndef ATP_STATIC_ROUTING_HELPER_H
#define ATP_STATIC_ROUTING_HELPER_H

#include "ns3/ipv4-routing-helper.h"
#include "ns3/ipv4-address.h"
#include "ns3/atp-static-routing.h"
#include "ns3/ipv4.h"
 ...
 */
class ATPStaticRoutingHelper : public Ipv4RoutingHelper
{
  public:
    /*
     ...
     */
    ATPStaticRoutingHelper(const ATPStaticRoutingHelper& o);

    // Delete assignment operator to avoid misuse
    ATPStaticRoutingHelper& operator=(const ATPStaticRoutingHelper&) = delete;
     ...
     */
    ATPStaticRoutingHelper* Copy() const override;
     ...
     */
    Ptr<ATPStaticRouting> GetStaticRouting(Ptr<Ipv4> ipv4) const;
